...
the same nine-task BioPAWS-2 mixture with the same recipe. Macro is over the eight
...
\midrule
Protein homology (standard)  & 0.998 & 0.998 & $+0.000$ \\
Subcellular localization     & 0.803 & 0.791 & $+0.011$ \\
Promoter detection           & 0.865 & 0.837 & $+0.028$ \\
Fold class (7-way)           & 0.570 & 0.518 & $+0.051$ \\
Central Dogma                & 0.615 & 0.615 & $+0.000$ \\
Signal peptide               & 0.924 & 0.941 & $-0.017$ \\
Natural-product peptide      & 0.867 & 0.840 & $+0.027$ \\
Variant effect (ProteinGym)  & 0.625 & 0.636 & $-0.011$ \\
\midrule
\textbf{Macro (8 tasks)}     & \textbf{0.783} & \textbf{0.772} & $+0.011$ \\
\bottomrule
\end{tabular}
\end{table}

The two models are \emph{statistically indistinguishable} under joint SFT: the macro gap is
$+0.011$, the mean per-task difference is $+0.010$, the largest single-task difference is
$0.051$ (fold class), and the sign of the difference is inconsistent across tasks (five
...
model with no domain pretraining reaches macro 0.772), while OmniGene-4-MM's distinctive
