...
MM_DIR     = "/root/autodl-tmp/dnagpt/outputs/OmniGene-4-MM-stage3v2"
...
OUT_REPORT = "/root/autodl-tmp/dnagpt/outputs/OmniGene-4-MM-stage3v2/eval_report.json"
...
assert loaded > 400, f"LoRA load failed: only {loaded}"
