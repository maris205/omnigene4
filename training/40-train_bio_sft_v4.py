...
CHECKPOINT_DIR = "/root/autodl-tmp/dnagpt/checkpoints_sft_v4"
...
tokenizer = AutoTokenizer.from_pretrained(SFT_V3_DIR)
...
v3_lora = torch.load(f"{SFT_V3_DIR}/lora_weights.pt", map_location="cpu")
ms = model.state_dict()
loaded = 0
...
v3_embed = torch.load(f"{SFT_V3_DIR}/embedding_weights.pt", map_location="cpu")
